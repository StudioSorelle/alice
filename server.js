  ...
  if (style === 'Seizoensgebonden') {
    ...
    if (topicClean && topicClean !== '__any__') {
      ...
      if (topicDef && topicDef[l]) {
        ...
        parts.push(l === 'nl'
          ? 'Onderwerp: ' + topicClean + '. Dit is het centrale onderwerp van het schilderij — alle andere elementen zijn hieraan ondergeschikt. Hou het bij dit onderwerp en voeg geen grote extra elementen toe.'
          : 'Subject: ' + topicClean + '. This is the central subject of the painting — all other elements are secondary to it. Stay focused on this subject and do not introduce large unrelated elements.');
      }
    }
